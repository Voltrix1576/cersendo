...
public class SwerveConstants {
    ...
    public static final double poseTurningFactor = 360 / gearTurning;
    ...
    public static final double rearLeftAbsulotEncoderOffset = 79.5;
    ...
    public static final double frontLeftAbsulotEncoderOffset = 338.9; 
    ...
    public static final double rearRightAbsulotEncoderOffset = 139.5; 
    ...
    public static final double frontRightAbsulotEncoderOffset = 266.13; 
    public static final boolean frontRightIstDriveMotorInverted = false; 
